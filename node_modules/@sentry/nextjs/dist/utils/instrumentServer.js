            ...
            return tslib_1.__generator(this, function (_a) {
                if (!sdkSetupComplete) {
                    try {
                        ...
                        require(path.resolve(process.env.SENTRY_SERVER_INIT_PATH));
                    }
                    catch (err) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                local.run(function () {
                    ...
                    if (currentScope) {
                        currentScope.addEventProcessor(function (event) { return addRequestDataToEvent(event, req); });
 ...
 */
function addRequestDataToEvent(event, req) {
    ...
    event.request = tslib_1.__assign(tslib_1.__assign({}, event.request), { data: req.body, url: req.url.split('?')[0], cookies: req.cookies, headers: req.headers, method: req.method, query_string: req.query });
    return event;
}
