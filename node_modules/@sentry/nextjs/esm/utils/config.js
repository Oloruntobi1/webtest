...
var _injectFile = function (entryProperty, injectionPoint, injectee) {
    ...
    if (typeof injectedInto === 'string') {
        ...
        injectedInto = __spread(injectedInto, [injectee]);
    }
    else {
        ...
        if (typeof injectedInto.import === 'string') {
            ...
            importVal = __spread(injectedInto.import, [injectee]);
        }
        injectedInto = __assign(__assign({}, injectedInto), { import: importVal });
    }
    entryProperty[injectionPoint] = injectedInto;
};
var injectSentry = function (origEntryProperty, isServer) { return __awaiter(void 0, void 0, void 0, function () {
 ...
 */
export function withSentryConfig(providedExports, providedSentryWebpackPluginOptions) {
    ...
    var newWebpackExport = function (config, options) {
        ...
        new SentryWebpackPlugin(__assign(__assign({ dryRun: options.dev, release: getSentryRelease(options.buildId) }, defaultSentryWebpackPluginOptions), providedSentryWebpackPluginOptions)));
        return newConfig;
    };
    return __assign(__assign({}, providedExports), { productionBrowserSourceMaps: true, webpack: newWebpackExport });
}
/**
