 ...
 */
export function addRequestDataToEvent(event, req) {
    ...
    event.request = __assign(__assign({}, event.request), { data: req.body, url: req.url.split('?')[0], cookies: req.cookies, headers: req.headers, method: req.method, query_string: req.query });
    return event;
}
